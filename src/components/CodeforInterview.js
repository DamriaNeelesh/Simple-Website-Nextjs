...
const CodeforInterview = () => {
    return (
        <Box m={4} marginTop={10} style={{ height: '78vh'}}>
            <Box>
                <Typography variant="h4">Sample Website using Next.js</Typography>
            ...
            <Box>
                ...
                <Typography>When I am not coding my next project, I enjoy spending my time doing any of the following: </Typography>
                <List>
